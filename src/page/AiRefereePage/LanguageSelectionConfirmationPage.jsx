...
const TRANSLATIONS = {
  English: {
    ...
    confirmationText:
      "You've chosen <span class='color-orange'>English</span> as your preferred language. Voice responses will be provided and answered in English only throughout the reference session. Please note that this setting cannot be changed once the session begins.",
    backButton: "Back",
  ...
  Japanese: {
    ...
    importantInfo: "重要な情報",
    confirmationText:
      "あなたは<span class='color-orange'>英語</span>を優先言語として選択しました。音声応答は、参照セッション中に英語でのみ提供され、回答されます。この設定は、セッションが始まると変更できないことに注意してください。",
    backButton: "戻る",
    confirmButton: "確認",
  },
};
        ...
        <div className="row d-flex justify-content-center align-items-center mt-4 px-3">
          ...
          <p
            dangerouslySetInnerHTML={{
              __html: TRANSLATIONS[language].confirmationText,
            }}
          />
