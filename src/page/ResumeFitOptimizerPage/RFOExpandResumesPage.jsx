// src/pages/RFOExpandResumesPage.js
import React from "react";
import Header from "../../components/Result/Header";
import { Row, Col } from "react-bootstrap";
import Sidebar from "../../components/MockMainDashboard/Sidebar";
import RFOCompareResumes from "../../components/ResumeFitOptimizer/RFOExpandResume";
import "../../styles/ResumeFitOptimizerStyles/ResumeFitOptimizer.css";


function RFOExpandResumesPage() {
  return (
    <>
...
export default RFOExpandResumesPage;
