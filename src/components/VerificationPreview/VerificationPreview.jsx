  ...
  return (
    <div className="d-flex justify-content-center w-100">
      <div className="verification-preview d-flex justify-content-center align-items-center flex-column">
        <b> Verification Preview</b>

        <div className="preview-image-container mt-2">
          <img src={image} alt="Verification preview" />
        </div>

        <div className="guidelines-container">
          <b>Verification Guidelines:</b>
          <ul>
            <li>Your face is clearly visible and well-lit</li>
            <li>Your ID document is readable and all corners are visible</li>
            <li>There is no glare or shadow obscuring important information</li>
            <li>The images are not blurry or pixelated</li>
          </ul>
