        ...
        <div className="login-container">
          ...
          <div className="agreenment-box-check">
            <input 
              type="checkbox"
              id="form-check-input"
              className="form-check-input btn-modal"
              checked={isChecked}
              onChange={handleCheckboxChange} />
            <label for="form-check-input" className="text-center form-check-label">
          ...
          <Modal
            ...
            onHide={handleClose}
            centered
            className="dpa-modal-agreement"
            backdrop="static"
          >
            <Modal.Body>
              <div className="dpa-container d-flex justify-content-between align-items-center">
                <div className="dpa-content d-flex flex-column align-items-center justify-content-start">
                  ...
                  <div className="section">
                    <span className="section-title">Purpose and Scope:</span>
                  ...
                  <div className="section">
                    <span className="section-title">Data Collected:</span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">Purpose of Data Processing: </span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">Data Storage and Security:</span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">Data Sharing and Transfers:</span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">User Rights: </span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">International Data Transfers</span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">Changes to the Agreement:</span>
                    <p className="section-description">
                  ...
                  <div className="section">
                    <span className="section-title">Acceptance</span>
                    <p className="section-description acceptance">
