...
const PricingSection = forwardRef(({ isPricingVisible }, ref) => {
  ...
  return (
    <section
      ref={ref}
      id="pricing"
      className={`snappcheck-pricing-container d-flex align-items-center w-100 fade-in ${
