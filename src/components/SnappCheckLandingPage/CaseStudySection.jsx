            ...
            {testimonials.map((testimonial, index) => (
              <Carousel.Item key={index}>
                <div className="testimonial-container">
                  ...
                  {/* Second Card (wraps around to beginning if needed) */}
                  <div className="testemony-card">
                    <b className="color-blue">
                      {testimonials[getSecondCardIndex(index)].title}
                    </b>
                    <div className="d-flex gap-2 mt-3">
                      <svg
                        width="30"
                      ...
                      <p>
                        {
                          testimonials[getSecondCardIndex(index)]
                            .content
                        }
                      </p>
                    </div>
                    <b className="testimonial-company">
                      {
                        testimonials[getSecondCardIndex(index)]
                          .author
                      }
