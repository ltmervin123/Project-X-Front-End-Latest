...
import DeleteUserPopUp from "../PopUpComponents/DeleteUserPopUp";
import EditUserPopUp from "../PopUpComponents/EditUserPopUp";
import ResetPasswordPopUp from "../PopUpComponents/ResetPasswordPopUp";
...
const UserProfileTables = ({
  ...
  const StatusOptionsMenu = ({ index, user }) => {
    return (
  ...
  return (
    ...
    >
                ...
                <td className="position-relative">
                  <div className="d-flex align-items-center justify-content-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setShowStatusOptions(
                          showStatusOptions === index ? null : index
                        )
                      }
                    >
                      <svg
                      ...
                      {showStatusOptions === index && (
                        <StatusOptionsMenu index={index} user={user} />
                      )}
                    </button>
                  </div>
                </td>
                ...
                <td className="d-flex justify-content-center align-items-center">
                  <div className="d-flex align-items-center gap-2 position-relative">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setShowActionOptions(
                          showActionOptions === index ? null : index
                        )
                      }
                    >
                      <svg
                      ...
                      {showActionOptions === index && (
                        <ViewDetailsMenu index={index} user={user} />
                      )}
                    </button>
                  </div>
                </td>
      ...
      {showWarnPopup && (
        <WarnUserPopup
          onClose={() => setShowWarnPopup(false)}
