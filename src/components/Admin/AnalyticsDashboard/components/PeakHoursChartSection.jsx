      ...
      <Col md="6">
        <div className={`peak-hours-chart-container fade-in ${isVisible ? "visible" : ""}`}>
          <div className="chart-content">
            ...
            <p className="chart-subtitle mb-0">Busiest times by hour of day for {selectedCompany === "All Company" ? "all companies" : <span className="color-orange">{selectedCompany}</span>}</p>
          </div>
      ...
      <Col md="6">
        <div className={`peak-hours-chart-container fade-in ${isVisible ? "visible" : ""}`}>
          <div className="chart-content">
            ...
            <p className="chart-subtitle mb-0">Most active users on the platform for {selectedCompany === "All Company" ? "all companies" : <span className="color-orange">{selectedCompany}</span>}</p>
          </div>
