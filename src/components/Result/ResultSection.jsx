...
const ResultSection = ({ interviewId }) => {
  ...
  const handleViewClick = (view) => {
    ...
    const detailViews = [
      // Skills related
      'technical skills', 'soft skills', 'skill relevance','skill diversity', 'skill score',
      // Grammar related
      'sentence structure', 'verb tense', 'word choice', 'pronoun usage', 'grammar score',
      // Experience related
      'duration', 'progression', 'achievements', 'role count', 'experience score',
      // Relevance related
      'industry alignment', 'key requirements', 'role fit', 'job match', 'relevance score'
    ];
