    ...
    English: {
        assessment: {
            ...
            ratings: {
                exceptional: {
                    label: "Exceptional",
                    description: "Performance consistently exceeds expectations in all areas."
                },
                exceedsExpectations: {
...
const getOverallAssessmentText = (category) => {
    ...
    const translations = {
        English: {
            ...
            leadershipAndManagementSkills: "Overall performance in Leadership and Management",
            strategicLeadershipAndVision: "Overall assessment of strategic leadership",
            businessImpactAndResults: "Overall Assessment of Business Impact and Results",
            teamLeadershipAndOrganizationalDevelopment: "Overall Assessment of Team Leadership and Organizational Development",
            decisionMakingAndProblemSolving: "Overall Assessment of Decision Making and Problem Solving",
        ...
        Japanese: {
            ...
            teamLeadershipAndOrganizationalDevelopment: "チームリーダーシップと組織開発の総合評価",
    ...
    return translations[language][category] || 
           `${language === "Japanese" ? "総合" : "Overall"} ${formatCategories(category)} ${language === "Japanese" ? "評価" : "Assessment"}`;
};
        ...
        <div className="job-performance-assessment-content">
            ...
            <Form className="job-performance-assessment-form">
                <div className="form-header">
                    ...
                    <p className="mb-0"> {t.question} {category}?</p>
                </div>
