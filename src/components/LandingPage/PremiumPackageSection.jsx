...
const PremiumPackageSection = () => {
  ...
  return (
    ...
    >
      <h1 id="mockpricing" ref={headerRef}>
        Pricing Plans
      </h1>{" "}
      {/* Added ref to <h1> */}
      <div className="subcription-pricing-container d-flex align-items-center justify-content-center flex-wrap gap-5">
        <div className="subscription-card">
          <div className="subscription-card-bg d-flex flex-column gap-4">
            ...
            <div className="subcription-pricing d-flex justify-content-center align-items-end">
              <p className="yen-price">¥ 0.00 </p>/ 1 Round of Interview
            </div>
            <div className="d-flex justify-content-center align-items-center subscription-button-container">
              <button className="btn-choose-plan" onClick={handlePaymentMethod}>
                Choose Plan
              </button>
            </div>
          </div>
        ...
        <div className="subscription-card">
          <div className="subscription-card-bg d-flex flex-column gap-4">
            ...
            <div className="subcription-pricing d-flex justify-content-center align-items-end">
              <p className="yen-price">¥ 500.00 </p>/ 10 Rounds of Interview
            </div>
            <div className="d-flex justify-content-center align-items-center subscription-button-container">
              <button className="btn-choose-plan" onClick={handlePaymentMethod}>
                Choose Plan
          ...
          <div className="subscription-card-bg d-flex flex-column gap-4">
            ...
            <div className="subscription-list-container d-flex flex-column gap-1">
              ...
              <p>
                ...
                <svg width="17" height="13"></svg>
                Application Tracker <span> (Coming soon)</span>{" "}
              </p>
            </div>
            <div className="subcription-pricing d-flex justify-content-center align-items-end">
              <p className="yen-price">¥ 2,000.00 </p>/ Unlimited Rounds
            </div>
            <div className="d-flex justify-content-center align-items-center subscription-button-container">
              <button
                className="btn-choose-plan active"
      ...
      <div className="subcription-pricing-container my-5 d-flex align-items-center justify-content-center flex-wrap gap-5">
        <div className="subscription-card active">
          <div className="subscription-card-bg d-flex flex-column gap-4">
            ...
            <div className="subscription-list-container d-flex flex-column gap-1">
              <p className="subscription-list-content">
                Kindly send us an email regarding{" "}
                <a href="/commingsoon" className="color-blue">
                  Mock AI Interview{" "}
                </a>{" "}
                Pricing
              </p>
            </div>
            <div className="subcription-pricing d-flex justify-content-center align-items-end"></div>
            <div className="d-flex justify-content-center align-items-center subscription-button-container">
