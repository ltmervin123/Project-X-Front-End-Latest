  ...
  return (
    <section className="bundle-mock-interview-container d-flex align-items-center justify-content-center flex-column gap-3">
      ...
      <div className="custom-bundle-mock-interview-container d-flex justify-content-center align-items-center flex-column">
        ...
        <div className="content-bundle-mock w-100 d-flex flex-column justify-content-center align-items-center gap-3 position-relative">
          <div className="bundle-mock-bg">
            <p>
              Resume Fit Optimizer is a smart tool that refines your resume by
              highlighting relevant strengths and provides detailed insights on
              how well it aligns with a specific job, boosting your chances of
              success.
            </p>
            ...
            <defs>
              <clipPath id="clip0_1430_724">
                <rect
                  ...
                  height="188.562"
                  fill="white"
                  transform="translate(272.165 163.301) rotate(150)"
                />
              </clipPath>
            </defs>
          </svg>
      ...
      <div className="bundle-bg2">
        ...
        <p>
          Simply upload your current resume along with the job description, and
          the app will refine and emphasize areas in your resume that are most
          relevant to the job’s requirements without altering content.
          Additionally, it will provide detailed analytics to assess how well
          your qualifications align with the role, increasing your chances of
          passing resume screenings and advancing in the hiring process.
        </p>
      </div>
      <div className="step-container d-flex align-items-center justify-content-around ">
        <div className="step-card d-flex align-items-center  justify-content-start  flex-column gap-5">
          ...
          >
            <path
              d="M31.9375 54.75V17.5656L20.075 29.4281L13.6875 22.8125L36.5 0L59.3125 22.8125L52.925 29.4281L41.0625 17.5656V54.75H31.9375ZM9.125 73C6.61562 73 4.46821 72.1073 2.68275 70.3218C0.897291 68.5363 0.00304167 66.3874 0 63.875V50.1875H9.125V63.875H63.875V50.1875H73V63.875C73 66.3844 72.1073 68.5333 70.3218 70.3218C68.5364 72.1103 66.3874 73.003 63.875 73H9.125Z"
              fill="#F46A05"
            />
          </svg>
          <div className="text-center">
            ...
            <p>
              Upload your current resume and the job description you're applying
              for.
            </p>
          </div>
        </div>
        <div className="step-card d-flex align-items-center justify-content-start  flex-column gap-5">
          ...
          <div className="text-center">
            ...
            <b>AI Analysis</b>
            <p>
              Our AI analyzes both documents to identify key requirements and
              match your skills.
            </p>
          </div>
        </div>
        <div className="step-card d-flex align-items-center justify-content-start flex-column gap-5">
          ...
          <div className="text-center">
            ...
            <p>
              Receive a customized resume tailored to highlight your relevant
              skills for the job.
            </p>
          </div>
        </div>
