...
const AboutHRHatchSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className={`about-hr-hatch-container d-flex align-items-center flex-column${
        isVisible ? " fade-in" : ""
      }`}
      id="whyhrhacth"
    >
      ...
      <div className="about-content-container d-flex align-items-center flex-column flex-md-row">
        <div className="about-main-content mb-4 mb-md-0">
          ...
          <p>
            ...
            seekers and employers by bridging the gap between talent and
            opportunity. We offer personalized support and innovative solutions
            that build confidence, streamline hiring, and drive sustainable
            growth for all.
          </p>
        </div>
