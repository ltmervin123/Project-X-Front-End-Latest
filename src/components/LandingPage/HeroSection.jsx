...
const HeroSection = () => {
  return (
    <>
      <section className='hero-container d-flex align-items-center flex-column '>
        <h1>HR-HATCH</h1>
        <h2>
        ...
        <Container className='custom-hero-container'>
          <Row className="d-flex align-items-center justify-content-center">
            <Col md={5} className='position-relative'>
              ...
              <svg className='arrow-svg-pointing-btn' width="80" height="80" viewBox="0 0 124 122" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Wrap Button in Link */}
                ...
                <a href="/login" className="d-flex align-items-center justify-content-center">
                  ...
                  <svg className='rocket-icon' width="30" height="30" viewBox="0 0 41 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.58912 26.2823L2.34912 24.7223C2.34912 24.7223 2.34912 20.0423 3.90912 15.3623C5.46912 10.6823 16.3891 10.6823 16.3891 10.6823M8.58912 26.2823L14.8291 32.5223M8.58912 26.2823C8.58912 26.2823 14.8291 10.6823 22.6291 6.00227C30.4291 1.32227 39.7891 1.32227 39.7891 1.32227C39.7891 1.32227 39.7891 10.6823 35.1091 18.4823C30.4291 26.2823 14.8291 32.5223 14.8291 32.5223M14.8291 32.5223L16.3891 38.7623C16.3891 38.7623 21.0691 38.7623 25.7491 37.2023C30.4291 35.6423 30.4291 24.7223 30.4291 24.7223" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M0.789062 40.322L7.02906 37.202L3.90906 34.082L0.789062 40.322Z" fill="white" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M27.309 15.3622C28.1706 15.3622 28.869 14.6638 28.869 13.8022C28.869 12.9406 28.1706 12.2422 27.309 12.2422C26.4475 12.2422 25.749 12.9406 25.749 13.8022C25.749 14.6638 26.4475 15.3622 27.309 15.3622Z" fill="white" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  GET STARTED
                  </a>
                </Button>
        ...
        <svg width="100%" height="45" viewBox="0 0 1917 45" fill="none" xmlns="http://www.w3.org/2000/svg">
