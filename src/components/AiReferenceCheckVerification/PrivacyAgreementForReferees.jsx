...
const TRANSLATIONS = {
  ...
  Japanese: {
    title: "照会者のプライバシー契約",
    subtitle:
      "この照会確認に参加する照会者として、以下の内容に同意していただきます：",
    purposeTitle: "情報使用の目的：",
    purposeDesc:
      "提供された情報は、候補者の雇用適性を評価する目的にのみ使用されます。",
    confidentialityTitle: "機密保持：",
    confidentialityDesc:
      "あなたの回答は厳重な機密として扱われます。採用プロセスに直接関わる承認された個人とのみ共有されます。",
    dataTitle: "データの取り扱い：",
    dataDesc:
      "あなたの個人情報（名前、役職、会社、連絡先、ID等）は、あなたの身元と候補者との専門的な関係を確認するために収集されます。このデータは安全に保管され、採用目的に必要な期間のみ保持されます。",
    voluntaryTitle: "自主的な参加：",
    voluntaryDesc:
      "照会の提供は任意です。回答を提出することにより、あなたは自由意思でこれを行い、提供する情報が知る限り正確であることを確認するものとします。",
    complianceTitle: "データ保護法の遵守：",
    complianceDesc:
      "この照会確認を実施する会社は、該当する場合、一般データ保護規則（GDPR）および日本の個人情報保護法（APPI）を含むすべての適用されるデータ保護法を遵守します。",
    acceptanceTitle: "承諾：",
    acceptanceDesc:
      "このプライバシー契約の条件を読み、理解し、同意したことを確認するために「同意する」をクリックしてください。",
    agreeButton: "同意する",
  },
};
      ...
      <Modal.Body>
        <div className="cr-privacy-container d-flex justify-content-between align-items-center">
          <div className="cr-privacy-content d-flex flex-column align-items-center justify-content-start">
            ...
            <div className="cr-section">
              <span className="cr-section-title">
                {TRANSLATIONS[language].acceptanceTitle}
              </span>
