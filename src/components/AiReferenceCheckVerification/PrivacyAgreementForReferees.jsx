          ...
          <div className="cr-privacy-content d-flex flex-column align-items-center justify-content-start">
            ...
            <div className="cr-section">
              ...
              <p className="cr-section-description">
                ...
                of evaluating the candidate's suitability for employment.
              </p>
            </div>
            <div className="cr-section">
              <span className="cr-section-title">Confidentiality:</span>
              <p className="cr-section-description">
                Your responses will be treated with the strictest
                confidentiality. They will only be shared with authorized
            ...
            <div className="cr-section">
              ...
              <p className="cr-section-description">
                Your personal details (e.g., name, title, company, contact
                information, ID) will be collected to verify your identity and
                professional relationship with the candidate. This data will be
                stored securely and only for as long as necessary for
            ...
            <div className="cr-section">
              ...
              <p className="cr-section-description">
                Providing a reference is voluntary. By submitting your
                responses, you confirm that you are doing so of your own free
                will and that the information you provide is accurate to the
            ...
            <div className="cr-section">
              ...
              <p className="cr-section-description">
                The company conducting this reference check complies with all
                applicable data protection laws, including but not limited to
                the General Data Protection Regulation (GDPR) and Japan’s Act on
                the Protection of Personal Information (APPI), as applicable.
              </p>
            </div>
            <div className="cr-section">
              ...
              <div className="d-flex gap-2 align-items-center justify-content-start p-1">
                ...
                <p className="cr-section-description m-0">
                  Click Agree to confirm that you have read, understood, and
                  agreed to the terms of this Privacy Agreement.
                </p>
              </div>
            </div>
