...
const BasicVideoRecording = ({ interviewType, category }) => {
  ...
  const tips = [
    "Speak Clearly: Pronounce your words clearly so that your answers can be easily understood.",
    "Use a Steady Pace: Talk at a steady speed, neither too fast nor too slow, to make your answers easy to follow.",
    "Maintain a Friendly Tone: Use a warm and friendly tone to make your answers more engaging and pleasant.",
    "Minimize Background Noise: Choose a quiet place to speak, ensuring your answers are clear and free from distractions.",
    "Check Your Microphone: Make sure your microphone is set up correctly and working well to capture your voice clearly.",
    "Visualize the Questions: Picture the questions in your mind to help you focus and provide relevant answers.",
    "Smile While You Speak: Smiling can improve your tone, making your answers sound more friendly and inviting.",
    "Avoid Filler Words: Limit the use of words like 'um,' 'uh,' or 'like' to keep your answers clear and concise.",
    "Use Simple Language: Choose clear and straightforward words to explain your ideas effectively.",
    "Be Mindful of Your Volume: Adjust your speaking volume to ensure your answers are clear without being too loud or too soft.",
    "Pause Between Thoughts: Take short pauses to gather your thoughts, which helps make your answers clearer.",
    "Stay on Topic: Keep your answers focused on the main points to ensure clarity and coherence.",
    "Express Enthusiasm: Let your excitement about the topic show in your voice to make your answers more engaging.",
    "Be Concise: Aim for clear and direct answers that avoid unnecessary details.",
    "Use Storytelling: Share relevant stories to illustrate your points and make your answers more relatable.",
    "Take a Breath: If you feel nervous, take a deep breath to calm yourself before delivering your answers.",
    "Think Before You Speak: Take a moment to organize your thoughts before responding to ensure clarity.",
    "Stay Positive: Use positive language to convey confidence and optimism in your answers.",
    "Summarize Key Points: At the end of your answers, briefly repeat the main points to reinforce clarity.",
    "Be Yourself: Allow your true personality to shine through in your responses, making your answers more genuine and relatable."
  ];
