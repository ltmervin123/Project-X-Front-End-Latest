    ...
    <div className="MockMainDashboard-content d-flex flex-column gap-2">
      ...
      >
        <div className="AiReference-table-title">
          <h4 className="mb-0 d-flex gap-2 align-items-center">Candidate Lists
          <div className="position-relative d-flex">
            ...
            {showTooltip && (
            <span className="job-tooltip-text">The Candidates page helps you track all potential hires through the reference checking process. Here you can view and manage candidate information and check their status. </span>
          )}
            </div>
          </h4>
