  ...
  agencyPartners: [
    {
      ...
      intro: "Welcome to the Agency Partners section. Here you can view and manage your recruitment agency partnerships.",
    },
    {
      title: "<span>2</span> Agency Search",
      element: ".search-wrapper",
      intro: "Quickly find agencies using the search bar. Search by agency name, contact person, or email.",
    },
    {
      title: "<span>3</span> Agency Performance",
      element: ".agency-performance-metrics",
      position: "bottom",
      intro: "Track key performance metrics including acceptance rates and reference completion rates for each agency.",
    },
    {
      title: "<span>4</span> Agency List",
      element: ".agency-partners-list",
      position: "top",
      intro: "View all your connected agencies, their status, and manage your partnerships.",
    },
    {
