        ...
        <div className="reset-pass-container">
          {passwordChanged ? (
            ...
            <>
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      ...
                      result="effect1_dropShadow_2750_1806"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_2750_1806"
                      result="shape"
                    />
                  </filter>
                </defs>
              ...
              <form
                className="reset-pass-form d-flex align-items-center flex-column justify-content-center"
                onSubmit={handleSubmit}
              >
                <div
                  className={`input-group mb-3 d-flex ${error ? "error" : ""}`}
                >
