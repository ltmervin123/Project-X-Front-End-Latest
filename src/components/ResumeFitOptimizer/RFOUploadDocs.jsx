              ...
              <Col className="upload-docs-content-col">
                <div className="ResumeFitOptimizer-uploadDocs-content d-flex flex-column gap-2">
                  <div className="header-text">
                    ...
                    <p>
                      Drag and drop or click to upload your resume and job
                      description
                    </p>
                  </div>
                  <div className="ResumeFitOptimizer-uploadDocs-resume uploadDocs-resume d-flex flex-column">
                    <div
                      className="d-flex flex-column align-items-center mb-3 upload-area gap-3"
