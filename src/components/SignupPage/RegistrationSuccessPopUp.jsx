  ...
  return (
    <div className="custom-regsuccess-container">
      <div className="regsuccess-popup-content d-flex justify-content-center">
        ...
        <p>
          Thank you for signing up! Check your email for confirmation, and click
          below to go to your dashboard.
        </p>
        <Button href="/login" className="btn-dashboard">
          Go to Login
        </Button>
        <svg
        ...
        >
          <path
            d="M132.083 68.75C129.013 68.75 126.5 71.2625 126.5 74.3333V91.0833C126.5 97.225 121.475 102.25 115.333 102.25C109.192 102.25 104.167 97.225 104.167 91.0833V65.9583C104.167 64.395 105.395 63.1667 106.958 63.1667C108.522 63.1667 109.75 64.395 109.75 65.9583V85.5C109.75 88.5708 112.263 91.0833 115.333 91.0833C118.404 91.0833 120.917 88.5708 120.917 85.5V65.9583C120.917 62.2564 119.446 58.706 116.828 56.0883C114.211 53.4706 110.66 52 106.958 52C103.256 52 99.706 53.4706 97.0883 56.0883C94.4706 58.706 93 62.2564 93 65.9583V91.0833C93 103.423 102.994 113.417 115.333 113.417C127.673 113.417 137.667 103.423 137.667 91.0833V74.3333C137.667 71.2625 135.154 68.75 132.083 68.75Z"
            fill="#F46A05"
          />
