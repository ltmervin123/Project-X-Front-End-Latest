...
const capitalizeWords = (str) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const isSignin = await signup(userDetail, SERVICE); // Use name state
  ...
  return (
    <div className="signup-info-container">
      <div className="info-create-acc-container">
        <div>
          <img src={logo} alt="Logo" width="296" height="44" />
        </div>
        <p>
        ...
        <div className="already-have-slash-login-container d-flex align-items-center justify-content-center flex-column position-relative">
          ...
          >
            <path
              d="M0.833984 1.12085V0.62085H0.333984V1.12085H0.833984ZM0.833984 50.2957H0.333984V50.7957H0.833984V50.2957ZM19.7718 50.6492C19.9671 50.4539 19.9671 50.1374 19.7718 49.9421L16.5898 46.7601C16.3946 46.5649 16.078 46.5649 15.8827 46.7601C15.6875 46.9554 15.6875 47.272 15.8827 47.4672L18.7111 50.2957L15.8827 53.1241C15.6875 53.3193 15.6875 53.6359 15.8827 53.8312C16.078 54.0265 16.3946 54.0265 16.5898 53.8312L19.7718 50.6492ZM38 0.62085H0.833984V1.62085H38V0.62085ZM0.333984 1.12085V50.2957H1.33398V1.12085H0.333984ZM0.833984 50.7957H19.4183V49.7957H0.833984V50.7957Z"
              fill="black"
            />
          </svg>
              ...
              <span className="input-group-text">
                ...
                >
                  <g filter="url(#filter0_d_1739_1418)">
                    <path
                      d="M37.5377 36.3323C37.1708 36.2123 34.8515 35.1669 36.3008 30.7615H36.28C40.0577 26.8708 42.9446 20.61 42.9446 14.4462C42.9446 4.96846 36.6423 0 29.3177 0C21.9885 0 15.7208 4.96615 15.7208 14.4462C15.7208 20.6354 18.5915 26.9215 22.3923 30.8031C23.8738 34.6892 21.2246 36.1315 20.6708 36.3346C13 39.1085 4 44.1646 4 49.1562V51.0277C4 57.8285 17.1862 59.3746 29.3892 59.3746C41.6108 59.3746 54.6308 57.8285 54.6308 51.0277V49.1562C54.6308 44.0146 45.5869 38.9977 37.5377 36.3323Z"
                      fill="white"
                    />
                  </g>
                  <defs>
                    <filter
                      id="filter0_d_1739_1418"
                      x="0"
                      y="0"
                      width="58.6309"
                      height="67.3745"
                    ...
                    >
                      ...
                      <feBlend
                        ...
                        result="effect1_dropShadow_1739_1418"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_1739_1418"
                        result="shape"
                      />
                    </filter>
                  </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_1739_1419"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_1739_1419"
                        result="shape"
                      />
                    </filter>
                  </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_1739_1420"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_1739_1420"
                        result="shape"
                      />
                    </filter>
                  </defs>
